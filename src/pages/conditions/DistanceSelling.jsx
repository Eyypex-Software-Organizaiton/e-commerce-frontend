    ...
    <div className="xs:mx-4  sm:container sm:mx-auto">
      <div className="text-justify">
        ...
        <p>
          ...
          şartlar çerçevesinde imzalanmıştır. <br />
          <br />
          ...
          <br /> İş bu sözleşmeyi kabul etmekle ALICI, sözleşme konusu siparişi
        ...
        <p className="">
          ...
          terimler karşılarındaki yazılı açıklamaları ifade edeceklerdir. <br />
          <br />
          ...
          <br /> SATICI : Ticari veya mesleki faaliyetleri kapsamında tüketiciye
          mal sunan veya mal sunan adına veya hesabına hareket eden şirketi,{" "}
          <br />
          ...
          <br /> MAL : Alışverişe konu olan taşınır eşyayı ve elektronik ortamda
        ...
        <p>
          ...
          düzenler. <br />
          <br /> Listelenen ve sitede ilan edilen fiyatlar satış fiyatıdır. İlan
        ...
        <p>
          ...
          Teslimat Adresi <br /> Telefon <br /> Faks <br /> Eposta/kullanıcı adı
        </p>
        ...
        <p className="mb-4">
          ...
          miktarı, marka/modeli, rengi, adedi) SATICI’ya ait internet sitesinde
        ...
        <p>
          ...
          kişi <br /> Fatura Adresi <br /> Sipariş Tarihi <br /> Teslimat tarihi{" "}
          <br /> Teslim şekli <br />
          <br />
        ...
        <p>
          ...
          sözleşmeyi feshetme hakkı saklıdır. <br />
          <br /> 9.3. SATICI, Sözleşme konusu ürünü eksiksiz, siparişte
          belirtilen niteliklere uygun ve varsa garanti belgeleri, kullanım
          kılavuzları işin gereği olan bilgi ve belgeler ile teslim etmeyi, her
          türlü ayıptan arî olarak yasal mevzuat gereklerine göre sağlam,
          ...
          ifası sırasında gerekli dikkat ve özeni göstermeyi, ihtiyat ve öngörü
          ile hareket etmeyi kabul, beyan ve taahhüt eder. <br />
          ...
          günlük süre içinde toplam bedeli ALICI’ya iade edeceğini kabul, beyan
          ve taahhüt eder. <br />
          ...
          gösterdiği adresteki kişi ve/veya kuruluşa tesliminden sonra ALICI'ya
          ait kredi kartının yetkisiz kişilerce haksız kullanılması sonucunda
          ...
          gün içerisinde nakliye gideri SATICI’ya ait olacak şekilde SATICI’ya
          iade edeceğini kabul, beyan ve taahhüt eder. <br />
          <br /> 9.8. SATICI, tarafların iradesi dışında gelişen, önceden
          öngörülemeyen ve tarafların borçlarını yerine getirmesini engelleyici
          ve/veya geciktirici hallerin oluşması gibi mücbir sebepler halleri
          nedeni ile sözleşme konusu ürünü süresi içinde teslim edemez ise,
          durumu ALICI'ya bildireceğini kabul, beyan ve taahhüt eder. ALICI da
          ...
          haizdir. ALICI tarafından siparişin iptal edilmesi halinde ALICI’nın
          nakit ile yaptığı ödemelerde, ürün tutarı 14 gün içinde kendisine
          ...
          14 gün içerisinde ilgili bankaya iade edilir. ALICI, SATICI tarafından
          ...
          tutamayacağını kabul, beyan ve taahhüt eder. <br />
          ...
          zararları, SATICI’nın ilk bildirimi üzerine derhal, nakden ve defaten
          tazmin edeceğini beyan ve taahhüt eder. <br />
          <br /> 9.13. ALICI, SATICI’ya ait internet sitesini kullanırken yasal
          ...
          yükümlülükler tamamen ve münhasıran ALICI’yı bağlayacaktır. <br />
          ...
          taciz edici şekilde, yasalara aykırı bir amaç için, başkalarının maddi
          ve manevi haklarına tecavüz edecek şekilde kullanamaz. Ayrıca, üye
          ...
          olduğu ve/veya işlettiği başka web sitelerine ve/veya başka içeriklere
          ...
          kişiyi desteklememekte ve Link verilen web sitesinin içerdiği
          bilgilere yönelik herhangi bir garanti niteliği taşımamaktadır. <br />
        ...
        <p>
          ...
          <br /> 10.2. Cayma hakkının kullanılması için 14 (ondört) günlük süre
          içinde SATICI' ya iadeli taahhütlü posta, faks veya eposta ile yazılı
          ...
          olması şarttır. Bu hakkın kullanılması halinde, <br />
          ...
          en geç 10 günlük süre içerisinde toplam bedeli ve ALICI’yı borç altına
          sokan belgeleri ALICI’ ya iade etmek ve 20 günlük süre içerisinde malı
          iade almakla yükümlüdür. <br />
          ...
          cayma hakkı süresi içinde malın veya ürünün usulüne uygun kullanılması
        ...
        <p>
          ...
          kullanılması daYönetmelik gereği mümkün değildir. <br />
        ...
        <p className="font-bold my-2">12. TEMERRÜT HALİ VE HUKUKİ SONUÇLARI</p>
        <p>
        ...
        <p>
          ...
          tüketici hakem heyetlerine başvuru yapılmaktadır. İşbu Sözleşme ticari
        ...
        <p>
          ...
          düzenlemeleri yapmakla yükümlüdür. <br />
          <br /> SATICI: <br />
          <br /> ALICI: <br />
          <br /> TARİH:
        </p>
