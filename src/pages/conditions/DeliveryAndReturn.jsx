    ...
    <div className="xs:mx-4  sm:container sm:mx-auto">
      <div className="text-justify">
        ...
        <p>
          ...
          mesafeli satış sözleşmesini kabul etmiş sayılırsınız. <br /> 2.
          ...
          <br /> 6. Satın alınan ürünün satılmasının imkansızlaşması durumunda,
          satıcı bu durumu öğrendiğinden itibaren 3 gün içinde yazılı olarak
          alıcıya bu durumu bildirmek zorundadır. 14 gün içinde de toplam bedel
          Alıcı’ya iade edilmek zorundadır.
        </p>
        <p className="font-bold my-2">SATIN ALINAN ÜRÜN BEDELİ ÖDENMEZ İSE:</p>
        <p className="">
        ...
        <p>
          ...
          almakla yükümlüdür. <br /> 19. ALICI’ nın kusurundan kaynaklanan bir
          ...
          yükümlüdür. Ancak cayma hakkı süresi içinde malın veya ürünün usulüne
          uygun kullanılması sebebiyle meydana gelen değişiklik ve bozulmalardan
          ALICI sorumlu değildir. <br /> 20. Cayma hakkının kullanılması
          nedeniyle SATICI tarafından düzenlenen kampanya limit tutarının altına
          düşülmesi halinde kampanya kapsamında faydalanılan indirim miktarı
          iptal edilir.
        </p>
        <p className="font-bold my-2">CAYMA HAKKI KULLANILAMAYACAK ÜRÜNLER:</p>
        <p>
        ...
        <p>
          ...
          ............, ........., bankası hesaplarımızdan (TL) herhangi birine
          yapabilirsiniz. <br />
          25. Sitemiz üzerinden kredi kartlarınız ile, Her türlü kredi kartınıza
