...
const DeliveryAndReturn = () => {
  return (
    <>
      <Helmet>
        <title>
          Teslimat ve İade Koşulları | Alışveriş Bilgileri - Nadide Home
        </title>
        <meta
          name="description"
          content="Ürün teslimatı ve iade süreçleri hakkında bilgi alın. Alışverişinizi güvende yapmanız için gerekli detaylar."
        />
      </Helmet>
      <div className="xs:mx-4  sm:container sm:mx-auto">
        <div className="text-justify">
          ...
          <p className="font-bold my-2">GENEL:</p>
          <p>
            ...
            ve mesafeli satış sözleşmesini kabul etmiş sayılırsınız. <br /> 2.
            ...
            ödenecektir. <br /> 4. Satın alınan her bir ürün, 30 günlük yasal
            süreyi aşmamak kaydı ile alıcının gösterdiği adresteki kişi ve/veya
            kuruluşa teslim edilir. Bu süre içinde ürün teslim edilmez ise,
            Alıcılar sözleşmeyi sona erdirebilir. <br /> 5. Satın alınan ürün,
            eksiksiz ve siparişte belirtilen niteliklere uygun ve varsa garanti
            belgesi, kullanım klavuzu gibi belgelerle teslim edilmek zorundadır.{" "}
            <br /> 6. Satın alınan ürünün satılmasının imkansızlaşması
          ...
          <p>
            ...
            kuruluşu tarafından Satıcı'ya ödenmez ise, Alıcı, sözleşme konusu
            ürünü 3 gün içerisinde nakliye gideri SATICI’ya ait olacak şekilde
          ...
          <p className="font-bold my-2">CAYMA HAKKI:</p>
          <p>
          ...
          <p>
            ŞİRKET <br /> ADI/UNVANI: <br /> ADRES: <br /> EPOSTA: <br /> TEL:{" "}
            <br /> FAKS:
          </p>
          <p className="font-bold my-2">CAYMA HAKKININ SÜRESİ:</p>
          <p>
          ...
          <p className="font-bold my-2">CAYMA HAKKININ KULLANIMI:</p>
          <p>
          ...
          <p className="font-bold my-2">İADE KOŞULLARI:</p>
          <p>
            18. SATICI, cayma bildiriminin kendisine ulaşmasından itibaren en
            geç 10 günlük süre içerisinde toplam bedeli ve ALICI’yı borç altına
            sokan belgeleri ALICI’ ya iade etmek ve 20 günlük süre içerisinde
            malı iade almakla yükümlüdür. <br /> 19. ALICI’ nın kusurundan
            kaynaklanan bir nedenle malın değerinde bir azalma olursa veya iade
            imkânsızlaşırsa ALICI kusuru oranında SATICI’ nın zararlarını tazmin
            etmekle yükümlüdür. Ancak cayma hakkı süresi içinde malın veya
            ürünün usulüne uygun kullanılması sebebiyle meydana gelen değişiklik
            ve bozulmalardan ALICI sorumlu değildir. <br /> 20. Cayma hakkının
            kullanılması nedeniyle SATICI tarafından düzenlenen kampanya limit
            tutarının altına düşülmesi halinde kampanya kapsamında faydalanılan
          ...
          <p>
            ...
            sonra başka ürünlerle karışan ve doğası gereği ayrıştırılması mümkün
            ...
            hakkının kullanılması da Yönetmelik gereği mümkün değildir. <br />
          ...
          <p className="font-bold my-2">TEMERRÜT HALİ VE HUKUKİ SONUÇLARI</p>
          <p>
            ...
            ücretini ALICI’dan talep edebilir ve her koşulda ALICI’nın borcundan
            dolayı temerrüde düşmesi halinde, ALICI, borcun gecikmeli ifasından
            dolayı SATICI’nın uğradığı zarar ve ziyanını ödeyeceğini kabul eder.
          </p>
          <p className="font-bold my-2">ÖDEME VE TESLİMAT</p>
          <p>
            24. Banka Havalesi veya EFT (Elektronik Fon Transferi) yaparak,
            ............, ........., bankası hesaplarımızdan (TL) herhangi
            birine yapabilirsiniz. <br />
