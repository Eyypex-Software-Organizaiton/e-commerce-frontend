...
import SepetÖzeti from './SepetÖzeti';
// import kart from '../assets/kart.png'

const OdemeIslemler = ({ handleTabClick }) => {
  return (
    <div className='flex'>
      <div className="border-2 w-[1000px] m-8">
        <div>
          <h2 className="m-2 pl-6 text-2xl tracking-wide font-semibold text-gray-500">
            ÖDEME SEÇENEKLERİ
          </h2>
          <p className="border-r-2 border-t-2 w-64 h-12 flex items-center font-semibold justify-center overflow-hidden whitespace-nowrap ">
            KREDİ/BANKA KARTI
          </p>
          <hr />
        </div>
